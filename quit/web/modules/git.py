...
from quit.web.modules.application import isLoggedIn
import json
...
def commits(branch_or_ref):
    ...
    try:
        ...
        if mimetype in ['text/html', 'application/xhtml_xml', '*/*']:
            ...
            response = make_response(render_template('commits.html', results=results, data=data, isLoggedIn=isLoggedIn))
